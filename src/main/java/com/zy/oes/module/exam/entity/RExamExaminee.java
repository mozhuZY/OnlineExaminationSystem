...
public class RExamExaminee extends AbstractEntity {
    ...
    private static List<EntityState> STATES = getStates();
    ...
    private static List<EntityState> getStates() {
        List<EntityState> stateList = new ArrayList<>();
        stateList.add(new EntityState(1, "已考试"));
        stateList.add(new EntityState(0, "已报名"));
        return stateList;
    }
}
