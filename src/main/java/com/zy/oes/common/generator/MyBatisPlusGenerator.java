package com.zy.oes.common.generator;
...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/oes?useUnicode=true&characterEncoding=UTF-8&useSSL=false");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("147258369asd");
        ...
        // 父包
        pc.setParent("com.zy.oes.module");
        // 自定义实体包名(不同的模块自己手动修改)
        pc.setEntity("entity");
        ...
        strategy.setSuperEntityClass("com.zy.oes.common.base.entity.AbstractEntity");
